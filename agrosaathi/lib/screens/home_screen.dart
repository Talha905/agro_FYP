...
/// Owned by Person A. Multi-language reactive & overflow-proof.
class HomeScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final farmerName = UserService.currentUser?.name ?? 'Farmer';
      ...
      builder: (context, langCode, _) {
        return ListView(
          ...
          children: [
              ...
              children: [
                Expanded(
                  child: Column(
                    ...
                    children: [
                      Text(
                        LocalizationService.tr('greeting_farmer'),
            ...
            // Active Growth Plans Section (Person D Integration)
            Row(
              mainAxisAlignment: MainAxisAlignment.spaceBetween,
              children: [
                Expanded(
